...
class configs {
  constructor(args) {
    ...
    this.sslRejectUnAuthorized =
      args.sslRejectUnAuthorized === undefined || args.sslRejectUnAuthorized === true
        ? true
        : false;
    this.serverIdHeader = args.serverIdHeader;
  }
  validateConfigs() {
  ...
  getConfigs() {
    ...
    this.uri =
      urlPrefix + this.host + ":" + this.port + "/" + this.apiVersion + "/" + this.vaultLoginUrl;
    ...
    let finalConfigs = {
      ...
      serverIdHeader: this.serverIdHeader
    };
